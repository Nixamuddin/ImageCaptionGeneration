...
const VoiceToText = () => {
  ...
  const populateLanguages = () => {
    ...
    setInputLanguage(languages[1].code); 
  };
  ...
  const handleDownload = () => {
    const textToDownload = resultText;
  ...
  <div className="box">
    ...
    <h1 className='text-center texttop'> Convert  Voice to Text</h1>
<div className="selections"> 
    <button className='btn btn-primary recordingbtn' onClick={recording ? handleStopRecording : handleSpeechRecognition}>
      {recording ? 'Stop Listening' : 'Start Listening'}
    </button>
    </div>
    <select className='language' value={inputLanguage} onChange={(e) => setInputLanguage(e.target.value)}>
      {languages.map((lang) => (
        <option className='option' key={lang.code} value={lang.code}>
          {lang.name}
        </option>
      ))}
    </select>
    ...
    <div className="container">
      ...
      <button className='download' onClick={handleDownload} disabled={downloadBtnDisabled}>
        Download
      </button>
